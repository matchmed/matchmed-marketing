...
const SECTIONS = [
  ...
  { num: '4A', title: 'Atlas Retention Index and practice intelligence', content: 'The Retention Index and related measures are derived exclusively from publicly available datasets, including Medicare Part B Provider Data published by CMS. They are historical and observational, not real-time. They are for informational purposes only and should not be used as the sole basis for employment or contracting decisions. They do not measure clinical quality, patient outcomes, compensation, or workplace culture. Specific component weights are proprietary trade secrets of MatchMed, LLC.' },
