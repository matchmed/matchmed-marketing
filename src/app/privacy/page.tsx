...
const SECTIONS: { num: string; title: string; content: string | string[] }[] = [
  ...
  {
    num: '05',
    title: 'How we use analytics to improve Atlas',
    content: [
      'We want Atlas to be genuinely useful to the physicians who rely on it, so we study how the product is used and where it can be better. We do this with privacy-protective analytics tools (including PostHog), and we\'ve configured them deliberately to respect the sensitivity of your professional activity.',
      'Here\'s what that means in practice:',
      'We do not track your identity to your browsing. Our analytics identify you only by an internal account ID, never by your name, email, or other personal details, which are never sent to our analytics tools.',
      'On matchmed.app (this marketing site) and Atlas public search pages, we collect pageviews, heatmaps, and anonymized search-funnel events. We do not run session recordings on those public pages, and we do not send search query text, names, or profile identifiers to analytics.',
      'We obscure page content. We use session recordings and heatmaps to understand how people navigate Atlas, where they get stuck, and which features help. These are configured to mask the text and information shown on the page, so what we see is how people move through the product (clicks, scrolling, navigation), not the specific content you view or type. Passwords and form entries are never captured in readable form.',
      'We keep it briefly and delete it. Analytics data is processed by our providers on servers in the United States and, in the case of session recordings, automatically deleted after 90 days.',
      'We never sell it, and we never hand it to sponsors. Your usage data is used by us to improve Atlas. We do not sell it, and we do not share your individual activity, recordings, or analytics with industry sponsors or partners. Consistent with the rest of this policy, information about you reaches a partner only when you specifically choose to share it, on a per-request basis.',
      'If you have questions about how we use analytics, or you\'d prefer to opt out of session recording, contact us at admin@matchmed.app.',
    ],
  },
  { num: '06', title: 'Communications', content: 'We may send promotional emails; you can unsubscribe at any time. If you opted in at registration, we may send SMS/MMS messages; opt out anytime by texting STOP. Transactional and compliance-related emails are sent regardless of marketing preferences.' },
  { num: '07', title: 'Retention of data', content: 'We retain personal information while your account is active or as needed to provide the Service. Upon a verified deletion request, we will action it within 45 days except where retention is required for legal compliance. Transaction data may be retained for accounting or tax purposes.' },
  { num: '08', title: 'Disclosure of data', content: 'We may disclose personal information where required by law; in the context of a business transaction; to service providers under confidentiality obligations; to fulfill your instructions to share your profile with industry partners (if opted in); or with your consent. Industry partners who receive your information are subject to contractual restrictions on its use. You may withdraw this consent at any time by contacting admin@matchmed.app.' },
  { num: '09', title: 'Security of data', content: 'We strive to use commercially acceptable means to protect your personal information. No method of transmission over the Internet is 100% secure, and we cannot guarantee absolute security.' },
  { num: '10', title: 'Your privacy rights', content: 'Regardless of your state of residence, you have the right to know, access, correct, and delete your personal information; opt out of tracking and sales of your personal information; and withdraw consent at any time. To exercise these rights, contact admin@matchmed.app. We will respond within 45 days.' },
  ...
  { num: '12', title: 'Eligibility', content: 'Our Services are not intended for individuals under the age of 18. We do not knowingly collect personally identifiable information from minors. Our Services are intended for physicians and healthcare professionals operating in the United States.' },
  { num: '13', title: 'Changes to this privacy policy', content: 'We may update this Privacy Policy from time to time. We will notify you of material changes by posting the new Policy and updating the effective date. Changes are effective when posted.' },
  { num: '14', title: 'Contact us', content: 'If you have any questions about this Privacy Policy, please contact us at admin@matchmed.app.' },
]
      ...
      <div className="subpage-content" style={{ maxWidth: 720, margin: '0 auto', padding: '4rem 3rem 6rem' }}>
        ...
        {SECTIONS.map((s) => (
          <section key={s.num} id={`p${s.num}`} style={{ marginBottom: '0' }}>
            ...
            {(Array.isArray(s.content) ? s.content : [s.content]).map((paragraph) => (
              <p key={paragraph} style={{ fontSize: 14, lineHeight: 1.8, color: '#8A8680', margin: '0 0 1rem' }}>{paragraph}</p>
            ))}
          </section>
        ))}
      </div>
